...
export const savedActivitySlice = createSlice({
  name: 'savedActivitySlice',
  initialState,
  reducers: {
...
export const { savePost, deletePost, clear } = savedActivitySlice.actions

export default savedActivitySlice.reducer
